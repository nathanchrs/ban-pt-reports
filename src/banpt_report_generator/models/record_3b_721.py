...
def refresh(reports):
    for report in reports:
        ...
        if_record_3b_721 = {
            ...
            'jumlah_judul_kegiatan_masyarakat_ts_2': if_judul_ts_2,
            'jumlah_judul_kegiatan_masyarakat_ts_1': if_judul_ts_1,
            'jumlah_judul_kegiatan_masyarakat_ts': if_judul_ts,
            'total_dana_kegiatan_masyarakat_ts_2': if_dana_ts_2,
            'total_dana_kegiatan_masyarakat_ts_1': if_dana_ts_1,
            'total_dana_kegiatan_masyarakat_ts': if_dana_ts,
        }

        report.write({'record_3b_721': [(0, 0, if_record_3b_721)]})

        el_record_3b_721 = {
            'program_studi': 'Teknik Elektro',
            'jumlah_judul_kegiatan_masyarakat_ts_2': el_judul_ts_2,
            'jumlah_judul_kegiatan_masyarakat_ts_1': el_judul_ts_1,
            'jumlah_judul_kegiatan_masyarakat_ts': el_judul_ts,
            'total_dana_kegiatan_masyarakat_ts_2': el_dana_ts_2,
            'total_dana_kegiatan_masyarakat_ts_1': el_dana_ts_1,
            'total_dana_kegiatan_masyarakat_ts': el_dana_ts,
        }

        report.write({'record_3b_721': [(0, 0, el_record_3b_721)]})

        ep_record_3b_721 = {
            'program_studi': 'Teknik Tenaga Listrik',
            'jumlah_judul_kegiatan_masyarakat_ts_2': ep_judul_ts_2,
            'jumlah_judul_kegiatan_masyarakat_ts_1': ep_judul_ts_1,
            'jumlah_judul_kegiatan_masyarakat_ts': ep_judul_ts,
            'total_dana_kegiatan_masyarakat_ts_2': ep_dana_ts_2,
            'total_dana_kegiatan_masyarakat_ts_1': ep_dana_ts_1,
            'total_dana_kegiatan_masyarakat_ts': ep_dana_ts,
        }

        report.write({'record_3b_721': [(0, 0, ep_record_3b_721)]})

        et_record_3b_721 = {
            'program_studi': 'Teknik Telekomunikasi',
            'jumlah_judul_kegiatan_masyarakat_ts_2': et_judul_ts_2,
            'jumlah_judul_kegiatan_masyarakat_ts_1': et_judul_ts_1,
            'jumlah_judul_kegiatan_masyarakat_ts': et_judul_ts,
            'total_dana_kegiatan_masyarakat_ts_2': et_dana_ts_2,
            'total_dana_kegiatan_masyarakat_ts_1': et_dana_ts_1,
            'total_dana_kegiatan_masyarakat_ts': et_dana_ts,
        }

        report.write({'record_3b_721': [(0, 0, et_record_3b_721)]})

        sti_record_3b_721 = {
            'program_studi': 'Sistem & Teknologi Informasi',
            'jumlah_judul_kegiatan_masyarakat_ts_2': sti_judul_ts_2,
            'jumlah_judul_kegiatan_masyarakat_ts_1': sti_judul_ts_1,
            'jumlah_judul_kegiatan_masyarakat_ts': sti_judul_ts,
            'total_dana_kegiatan_masyarakat_ts_2': sti_dana_ts_2,
            'total_dana_kegiatan_masyarakat_ts_1': sti_dana_ts_1,
            'total_dana_kegiatan_masyarakat_ts': sti_dana_ts,
        }

        report.write({'record_3b_721': [(0, 0, sti_record_3b_721)]})

        eb_record_3b_721 = {
            'program_studi': 'Teknik Biomedis',
            'jumlah_judul_kegiatan_masyarakat_ts_2': eb_judul_ts_2,
            'jumlah_judul_kegiatan_masyarakat_ts_1': eb_judul_ts_1,
            'jumlah_judul_kegiatan_masyarakat_ts': eb_judul_ts,
            'total_dana_kegiatan_masyarakat_ts_2': eb_dana_ts_2,
            'total_dana_kegiatan_masyarakat_ts_1': eb_dana_ts_1,
            'total_dana_kegiatan_masyarakat_ts': eb_dana_ts,
        }

        report.write({'record_3b_721': [(0, 0, eb_record_3b_721)]})
