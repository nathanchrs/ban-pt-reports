...
class Record_A3_1_1(models.Model):
    ...
    mahasiswa_baru_reguler = fields.Integer(string='Reguler Bukan Transfer')
    mahasiswa_baru_transfer = fields.Integer(string='Transfer')
    total_mahasiswa_reguler = fields.Integer(string='Reguler Bukan Transfer')
    total_mahasiswa_transfer = fields.Integer(string='Transfer')
    jumlah_lulusan_reguler = fields.Integer(string='Reguler Bukan Transfer')
