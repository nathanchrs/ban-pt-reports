...
def seed(context):
    ...
    project_1 = context.env['itb.hr_project'].create(dict(name='test_1', tipe='pengabdian', start='2014-03-09', state='valid', deskripsi_sispran='DES-01', reference='REF-01', nilai=1000000))
...
class TestRecord_3A_623(common.TransactionCase):
