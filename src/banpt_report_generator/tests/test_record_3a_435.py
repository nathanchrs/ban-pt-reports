...
class TestRecord_3A_435(common.TransactionCase):
    def test_refresh(self):
        report_1 = seed(self)

        report_1.refresh()

        matkul_1 = report_1.record_3a_435.search([['nama_dosen', '=', 'Ridwan Kamal'], ['kode_matkul', '=', 'IF9999']])
        ...
        matkul_2 = report_1.record_3a_435.search([['nama_dosen', '=', 'Ridwan Kamal'], ['kode_matkul', '=', 'IF9998']])
        ...
        matkul_3 = report_1.record_3a_435.search([['nama_dosen', '=', 'Ridwan Kamal'], ['kode_matkul', '=', 'IF9997']])
        ...
        matkul_4 = report_1.record_3a_435.search([['nama_dosen', '=', 'Ridwan Kamal'], ['kode_matkul', '=', 'IF9996']])
