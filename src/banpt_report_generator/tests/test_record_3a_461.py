...
class TestRecord_3A_461(common.TransactionCase):
    def test_refresh(self):
        ...
        ts_4 = report_1.record_3a_461.search([['jenis_tenaga_kependidikan', '=', 'Total']])
        self.assertEqual(ts_4.jenis_tenaga_kependidikan, 'Total')
        self.assertEqual(ts_4.jumlah_S3, 4)
        self.assertEqual(ts_4.jumlah_S2, 4)
        self.assertEqual(ts_4.jumlah_S1, 4)
        self.assertEqual(ts_4.jumlah_D4, 0)
        self.assertEqual(ts_4.jumlah_D3, 4)
        self.assertEqual(ts_4.jumlah_D2, 0)
        self.assertEqual(ts_4.jumlah_D1, 0)
        self.assertEqual(ts_4.jumlah_SMA_SMK, 4)
        self.assertEqual(ts_4.unit_kerja, '')
