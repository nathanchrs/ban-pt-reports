...
class TestRecord_3A_714(common.TransactionCase):
    def test_refresh(self):
        report_1 = seed(self)

        report_1.refresh()

        project_1_test = report_1.record_3a_714.search([['karya_haki', '=', 'test_1']])
        self.assertEqual(project_1_test.karya_haki, 'test_1')
