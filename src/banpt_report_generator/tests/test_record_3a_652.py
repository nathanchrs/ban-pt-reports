...
class TestRecord_3A_652(common.TransactionCase):
    def test_refresh(self):
        report_1 = seed(self)

        report_1.refresh()

        ts_1 = report_1.record_3a_652.search([['jenis_data', '=', 'Mahasiswa']])
        ...
        ts_2 = report_1.record_3a_652.search([['jenis_data', '=', 'Kartu Rencana Studi (KRS)']])
        ...
        ts_3 = report_1.record_3a_652.search([['jenis_data', '=', 'Jadwal Mata Kuliah']])
        ...
        ts_4 = report_1.record_3a_652.search([['jenis_data', '=', 'Nilai Mata Kuliah']])
        ...
        ts_5 = report_1.record_3a_652.search([['jenis_data', '=', 'Transkrip Akademik']])
        ...
        ts_6 = report_1.record_3a_652.search([['jenis_data', '=', 'Lulusan']])
        ...
        ts_7 = report_1.record_3a_652.search([['jenis_data', '=', 'Dosen']])
        ...
        ts_8 = report_1.record_3a_652.search([['jenis_data', '=', 'Pegawai']])
        ...
        ts_9 = report_1.record_3a_652.search([['jenis_data', '=', 'Keuangan']])
        ...
        self.assertEqual(ts_9.pengolahan_data_komputer_dengan_lan, 'checklist')
        self.assertFalse(ts_9.pengolahan_data_komputer_jaringan_luas, 'checklist')

        ts_10 = report_1.record_3a_652.search([['jenis_data', '=', 'Inventaris']])
        ...
        self.assertEqual(ts_10.pengolahan_data_komputer_dengan_lan, 'checklist')
        self.assertFalse(ts_10.pengolahan_data_komputer_jaringan_luas, 'checklist')

        ts_11 = report_1.record_3a_652.search([['jenis_data', '=', 'Perpustakaan']])
