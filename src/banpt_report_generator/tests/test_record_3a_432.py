...
class TestRecord_3A_432(common.TransactionCase):
    def test_refresh(self):
        ...
        dosen_1 = report_1.record_3a_432.search([['nidn', '=', '012-AAA-123-BBB']])
        ...
        dosen_2 = report_2.record_3a_432.search([['nidn', '=', '912091239812']])
        ...
        dosen_3 = report_3.record_3a_432.search([['nidn', '=', '2223123112']])
