            ...
            if 'II.A' in result and any(result['II.A']):
                ...
                #=============================================================
                    #for period,lines in result['II.A'].items():
                        if len(dat) > 1:
                            sheet2.merge_range('J' + str(current_row2) + ':J' + str(current_row2 + len(dat)),sem,fmt_box)
                        else:
                            sheet2.merge_range('J' + str(current_row2) + ':J' + str(current_row2 + 1),sem,fmt_box)
            ...
            if 'II.B' in result and any(result['II.B']):
                ...
                #=============================================================
                    #for period,lines in result['II.B'].items():
                        if len(dat) > 1:
                            sheet2.merge_range('J' + str(current_row2) + ':J' + str(current_row2 + len(dat) - 1),sem,fmt_box)
                        else:
                            sheet2.write('J' + str(current_row2),sem,fmt_box)
                        ...
                        if 'III.A.1.a.1' in result and any(result['III.A.1.a.1']):
                            ...
                            #=============================================================
                                #for period,lines in result['III.A.1.a.1'].items():
                                    if len(dat) > 1:
                                        sheet3.merge_range('J' + str(current_row3) + ':J' + str(current_row3 + len(dat) - 1),sem,fmt_box)
                                    else:
                                        sheet3.write('J' + str(current_row3),sem,fmt_box)
