    ...
    def allocate1(self):
        ...
        if man_akmil_kopassus:
            ...
            for applicant in man_akmil_kopassus:
                if kopassus_job.bukaan and kopassus_job.lowong > 0 and applicant.kecabangan_id in kopassus_kecabangan:
        ...
        if man_akmil_kostrad:
            ...
            for applicant in man_akmil_kostrad:
                if kostrad_job.bukaan and kostrad_job.lowong > 0 and applicant.kecabangan_id in kostrad_kecabangan:
