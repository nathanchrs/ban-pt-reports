...
class Publication_Author(models.Model):
	...
	day = fields.Date(string='Published',related='publication_id.day')
	publisher = fields.Char(related='publication_id.publisher')
	media = fields.Char(related='publication_id.media_id.name')
	score = fields.Float()
	role = fields.Selection([('author','Author'),('co-author','Co-Author')], 'Role', default='author')
